...
class QuantLlamaMLP(nn.Module):
    ...
    def __init__(self, org_module: nn.Module, config, args=None):
        super().__init__()
        self.config = config
        self.hidden_size = org_module.config.hidden_size
        self.intermediate_size = org_module.config.intermediate_size
        ...
        self.act_fn = ACT2FN[org_module.config.hidden_act]
...
class QuantLlamaAttention(nn.Module):
    ...
    def __init__(self, org_module: nn.Module, config: LlamaConfig, args=None):
        ...
        if org_module.layer_idx is None:
            logger.warning_once(
